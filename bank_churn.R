...
#Procederemos a hacer una limpieza de datos para su posterior procesamiento

str(train) 

#Visualizacion de las existencias de NA

any(is.na(train))
train[!complete.cases(train),]
summary(train)

#Ante la inexistencia de NA procedemos a sustituir una variable relevante para 
#el estudio por datos numericos (Gender)
...
#Analisis estadistico de "Balance"
...
#Analisis estadistico de "CreditScore"
...
#Analisis estadistio de "EstimatedSalary"
